function p(){let e=new Uint8Array(32);return crypto.getRandomValues(e),Array.from(e,t=>t.toString(16).padStart(2,"0")).join("")}function C(e,t){return{command:"npx",args:["-y","askjev-mcp"],env:{ASKJEV_TOKEN:e,ASKJEV_PORT:String(t)}}}function c(e,t){return JSON.stringify({mcpServers:{askjev:C(e,t)}},null,2)}function y(e){return JSON.stringify(e)}function b(e,t){return`import json, os, sys
path = sys.argv[1]
token = ${y(e)}
port = ${y(String(t))}
entry = {
...
`}function h(e){return btoa(unescape(encodeURIComponent(e)))}function k(e,t){return`#!/bin/bash
